whenSquaresAttack.state3 = function(){};
whenSquaresAttack.state3.prototype = {
    count: {
        zombie: 0,
        powerUp: 0,
        numStars: 0,
    ...
    preload: function(){
        game.load.tilemap('state3map', 'assets/tilemaps/state3map.json',null,Phaser.Tilemap.TILED_JSON);
    ...
    create: function(){
        ...
        // init map
        this.map = game.add.tilemap('state3map');
        ...
        this.sprite.crates.create(1400, 800, 'crate');
        this.sprite.crates.create(250, 500, 'crate');
        this.sprite.crates.create(800, 400, 'crate');
        ...
        this.sprite.stars.create(500, 440, 'star');
        this.sprite.stars.create(300, 200, 'star');

        // init text display
        game.add.text(CENTER_X, 10, 'Level 3', FONT_STYLE);
