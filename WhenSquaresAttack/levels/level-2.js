whenSquaresAttack.state2 = function(){};
whenSquaresAttack.state2.prototype = {
    count: {
        zombie: 0,
        numStars: 0,
        resetAll: function() {
    ...
    preload: function(){
        game.load.tilemap('state2map', 'assets/tilemaps/state2map.json',null,Phaser.Tilemap.TILED_JSON);
    ...
    create: function(){
        ...
        // init map
        this.map = game.add.tilemap('state2map');
        ...
        this.sprite.stars.create(1290, 200, 'star');
        this.sprite.stars.create(500, 900, 'star');
        this.sprite.stars.create(1000, 130, 'star');
        this.sprite.stars.create(600, 440, 'star');
        this.sprite.stars.create(300, 450, 'star');

        // init text display
        game.add.text(CENTER_X, 10, 'Level 2', FONT_STYLE);
