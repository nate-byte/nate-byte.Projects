...
#  Description: A bunch of recursive problems.
...
def countAbc(str):
  if len(str) == 0:
    ...
    if len(str) >= 3 and (str[0:3] == "abc" or str[0:3] == "aba"):
